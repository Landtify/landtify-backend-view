          ...
          <div class="col-10 ">
            <div class="login">
              <q-card class="my-card text-white" style="max-width: 400px">
                <q-card-section>
                  <div class="text-h4 text-weight-bold q-pa-md text-primary">Login</div>
                  <div class="text-6 q-pl-md q-pr-md q-pt-sm q-pb-sm text-primary">
                    Welcome to Landtify Admin. let’s access
                ...
                <q-card-section>
                  <div class="q-pa-md">
                    <q-form @submit="onSubmit" @reset="onReset" class="">
                      <q-input type="email" bottom-slots v-model="email" label="Email" hint="Your email address"
                      ...
                      <q-input type="password" bottom-slots v-model="password" label="Password" hint="Your password"
                        lazy-rules :rules="[ val => val && val.length > 0 || 'Please type something']">
                        <template v-slot:prepend>
                          <q-icon name="lock" />
                        </template>
                ...
                <q-card-section>
                  <q-form @submit.prevent="postReset" >
                    <div class="row text-center">
                      <div class="col-12">
                        <q-input type="email" bottom-slots v-model="resetEmail" label="Email" hint="Your email address"
                          lazy-rules :rules="[ val => val && val.length > 0 || 'Please type something']">
                          <template v-slot:prepend>
                            <q-icon name="fa-light fa-at" />
                          </template>
                      ...
                      <div class="col-12 q-mt-md">
                        <q-btn class="bg-primary text-white" type="submit">Submit</q-btn>
                      </div>
                    </div>
                  </q-form>
                </q-card-section>
...
const resetPassword = ref(false)
  ...
  const onSubmit = async () => {
    ...
    const token = admin.data.admin_details;
  ...
  // console.log(decoded, 'decoded');
    ...
    if (useStore.getAdmintype == "SuperAdmin") {
