      ...
      <div class="row q-pt-sm">
        <q-form @submit="onSubmit" @reset="onReset" class="">
          <div class="col-12 col-md-12 q-pl-md">
            <q-input label="User ID || Admin ID" class="" outlined v-model="postedbyid" hint="" />
          </div>
      ...
      <div class="q-pa-md row items-start q-gutter-md" v-if="fixed0">
        <q-card class="my-card-2 bg-primary text-white">
          <q-card-section>
              ...
              <div class="row q-pt-sm">
                <div class="col-12 col-md-6 q-pl-md">
                  <div class="text-h6">{{data.firstname}}</div>
                  <div class="text-subtitle2">First Name</div>
                </div>
                <div class="col-12 col-md-6 q-pl-md">
                  <div class="text-h6">{{data.lastname}}</div>
              ...
              <div class="row q-pt-sm">
                <div class="col-12 col-md-6 q-pl-md">
                  <div class="text-h6">{{data.usertype }}</div>
                  <div class="text-subtitle2">User Type</div>
                </div>
                <div class="col-12 col-md-6 q-pl-md">
                  <div class="text-h6">{{data.phone}}</div>
          ...
          <!-- <q-card-actions align="right">
            <q-btn @click="onDelete()" flat>Delete Property</q-btn>
          </q-card-actions> -->
        </q-card>
      </div>
...
const onSubmit = () => {
  ...
  axios.get(`${base}/admin/serve/property/${postedbyid.value}`,
