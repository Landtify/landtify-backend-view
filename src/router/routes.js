...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/all-users', component: () => import('pages/UsersPage.vue'), meta: { requireLogin: true } },
      { path: '/all-admin', component: () => import('pages/AdminPage.vue'), meta: { requireLogin: true } },
      ...
      { path: '/direct-buyer', component: () => import('components/user/DirectBuyerPage.vue'), meta: { requireLogin: true } },
      { path: '/direct-seller', component: () => import('components/user/DirectSellerPage.vue'), meta: { requireLogin: true } },
